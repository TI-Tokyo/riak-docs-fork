...
```bash
sudo pkg_add -r https://files.tiot.jp/riak/kv/2.2/3.0.1/freebsd/11.1/riak-3.0.1.txz
```
...
```bash
sudo pkg_add -r https://files.tiot.jp/riak/kv/2.2/3.0.1/freebsd/10.4/riak-3.0.1.txz
```
