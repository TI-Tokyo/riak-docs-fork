...
toc: true
aliases:
  - /riak-docs/riak/2.9.4/dev/advanced/mapreduce/
  - /riak-docs/riak/kv/2.9.4/dev/advanced/mapreduce/
---
...
[`set-union`] function. In that case, the first set of inputs might be `[1,2.9.4]`,
