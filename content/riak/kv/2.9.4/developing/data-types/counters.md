...
toc: true
aliases:
  - /riak-docs/riak/2.9.4/dev/using/data-types/counters
  - /riak-docs/riak/kv/2.9.4/dev/using/data-types/counters
  - /riak-docs/riak/2.9.4/dev/data-modeling/data-types/counters
  - /riak-docs/riak/kv/2.9.4/dev/data-modeling/data-types/counters
---
