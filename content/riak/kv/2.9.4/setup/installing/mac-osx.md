...
toc: true
aliases:
  - /riak-docs/riak/2.9.4/ops/building/installing/Installing-on-Mac-OS-X
  - /riak-docs/riak/kv/2.9.4/ops/building/installing/Installing-on-Mac-OS-X
  - /riak-docs/riak/2.9.4/installing/mac-osx/
  - /riak-docs/riak/kv/2.9.4/installing/mac-osx/
---
...
2.9.4 and Clang 902.0.39.1, Clang can build Riak.
{{% /note %}}
