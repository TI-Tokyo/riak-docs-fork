...
toc: true
aliases:
  - /riak-docs/riak/2.9.4/ops/building/installing/Installing-on-Debian-and-Ubuntu
  - /riak-docs/riak/kv/2.9.4/ops/building/installing/Installing-on-Debian-and-Ubuntu
  - /riak-docs/riak/2.9.4/installing/debian-ubuntu/
  - /riak-docs/riak/kv/2.9.4/installing/debian-ubuntu/
---
...
```bash
wget https://files.tiot.jp/riak/kv/2.9/2.9.4/ubuntu/bionic64/riak_2.9.2_amd64.deb
...
```bash
wget https://files.tiot.jp/riak/kv/2.9/2.9.4/ubuntu/xenial64/riak_2.9.2_amd64.deb
sudo dpkg -i riak_2.9.2_amd64.deb
```
...
```bash
wget https://files.tiot.jp/riak/kv/2.9/2.9.4/ubuntu/trusty64/riak_2.9.2_amd64.deb
sudo dpkg -i riak_2.9.2_amd64.deb
```
...
```bash
wget https://files.tiot.jp/riak/kv/2.9/2.9.4/ubuntu/precise64/riak_2.9.2_amd64.deb
sudo dpkg -i riak_2.9.2_amd64.deb
```
...
```bash
wget https://files.tiot.jp/riak/kv/2.9/2.9.4/debian/9/riak_2.9.2_amd64.deb
sudo dpkg -i riak_2.9.2_amd64.deb
```
...
```bash
wget https://files.tiot.jp/riak/kv/2.9/2.9.4/debian/8/riak_2.9.2_amd64.deb
sudo dpkg -i riak_2.9.2_amd64.deb
```
...
```bash
wget https://files.tiot.jp/riak/kv/2.9/2.9.4/debian/7/riak_2.9.2_amd64.deb
sudo dpkg -i riak_2.9.2_amd64.deb
```
...
```bash
wget https://files.tiot.jp/riak/kv/2.9/2.9.4/raspbian/buster/riak_2.9.2_armhf.deb
sudo dpkg -i riak_2.9.2_amd64.deb
```
