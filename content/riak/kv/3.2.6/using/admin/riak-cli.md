...
toc: true
aliases:
  - /riak/3.2.6/ops/running/tools/riak
  - /riak/kv/3.2.6/ops/running/tools/riak
---

[configuration file]: {{<baseurl>}}riak/kv/3.2.6/configuring/reference/
[escript]: http://www.erlang.org/doc/man/escript.html
[`riak admin`]: {{<baseurl>}}riak/kv/3.2.6/using/admin/riak-admin/#top
[configuration]: {{<baseurl>}}riak/kv/3.2.6/configuring/reference/
...
In Riak KV 3.2.6, riak daemon replaces riak start.
...
In KV 3.2.6 the response to this command would appear as:
