...
toc: true
aliases:
  - /riak/3.2.6/ops/running/cluster-admin
  - /riak/kv/3.2.6/ops/running/cluster-admin
---

[use admin riak admin#cluster]: {{<baseurl>}}riak/kv/3.2.6/using/admin/riak-admin/#cluster
...
[use admin riak admin#cluster-plan]: {{<baseurl>}}riak/kv/3.2.6/using/admin/riak-admin/#cluster-plan
[use admin riak admin#cluster-commit]: {{<baseurl>}}riak/kv/3.2.6/using/admin/riak-admin/#cluster-commit
