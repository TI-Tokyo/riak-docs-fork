...
version_history:
  in: "2.9.1+"
aliases:
  - /riak/kv/3.2.6/ops/advanced/aae/
  - /riak/3.2.6/ops/advanced/aae/
---
...
In Riak versions 2.9.1 and later, [TicTac AAE]({{<baseurl>}}riak/kv/3.2.6/using/cluster-operations/tictac-active-anti-entropy/) is included with releases as an option to be used in addition to or instead of traditional AAE in Riak.
