...
[concept causal context vc]: {{<baseurl>}}riak/kv/3.2.6/learn/concepts/causal-context/#vector-clocks
...
[concept strong consistency]: {{<baseurl>}}riak/kv/3.2.6/learn/concepts/strong-consistency
[dev kv model]: {{<baseurl>}}riak/kv/3.2.6/developing/key-value-modeling
[concept replication aae]: {{<baseurl>}}riak/kv/3.2.6/learn/concepts/replication/#active-anti-entropy
...
[repair recover failure recovery]: {{<baseurl>}}riak/kv/3.2.6/using/repair-recovery/failure-recovery
[repair recover repairs]: {{<baseurl>}}riak/kv/3.2.6/using/repair-recovery/repairs
...
* [Bucket Types]({{<baseurl>}}riak/kv/3.2.6/developing/usage/bucket-types)
