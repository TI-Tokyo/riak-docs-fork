...
[concept clusters ring]: {{<baseurl>}}riak/kv/3.2.5/learn/concepts/clusters/#the-ring
...
subdirectories. If you're using, say, [Bitcask]({{<baseurl>}}riak/kv/3.2.5/setup/planning/backend/bitcask) as a backend, navigate
