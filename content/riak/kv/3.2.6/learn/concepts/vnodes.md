...
toc: true
aliases:
  - /riak/3.2.6/theory/concepts/vnodes
  - /riak/kv/3.2.6/theory/concepts/vnodes
---

[concept causal context]: {{<baseurl>}}riak/kv/3.2.6/learn/concepts/causal-context
[concept clusters ring]: {{<baseurl>}}riak/kv/3.2.6/learn/concepts/clusters/#the-ring
...
subdirectories. If you're using, say, [Bitcask]({{<baseurl>}}riak/kv/3.2.6/setup/planning/backend/bitcask) as a backend, navigate
