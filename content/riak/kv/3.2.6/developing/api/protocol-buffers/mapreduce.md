...
toc: true
aliases:
  - /riak/3.2.6/dev/references/protocol-buffers/mapreduce
  - /riak/kv/3.2.6/dev/references/protocol-buffers/mapreduce
---
...
The JSON encoding is the same as [REST API]({{<baseurl>}}riak/kv/3.2.6/developing/usage/mapreduce/#rest) and
the external term format is the same as the [local Erlang API]({{<baseurl>}}riak/kv/3.2.6/developing/app-guide/advanced-mapreduce/#erlang)
