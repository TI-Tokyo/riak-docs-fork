...
toc: true
aliases:
  - /riak/3.2.6/dev/references/protocol-buffers/reset-bucket-props
  - /riak/kv/3.2.6/dev/references/protocol-buffers/reset-bucket-props
---
...
[bucket type]({{<baseurl>}}riak/kv/3.2.6/developing/usage/bucket-types) using the `type` value. If you do not
