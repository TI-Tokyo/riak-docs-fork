...
toc: true
aliases:
  - /riak/3.2.6/dev/references/http/counters
  - /riak/kv/3.2.6/dev/references/http/counters
---
...
The regular POST/PUT ([HTTP Store Object]({{<baseurl>}}riak/kv/3.2.6/developing/api/http/store-object)) and GET ([HTTP Fetch Object]({{<baseurl>}}riak/kv/3.2.6/developing/api/http/fetch-object)) responses apply here.
