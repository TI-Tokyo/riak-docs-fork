...
version_history:
  in: "2.1.0+"
aliases:
  - /riak/3.2.6/dev/advanced/write-once
  - /riak/kv/3.2.6/dev/advanced/write-once
---

[glossary vnode]: {{<baseurl>}}riak/kv/3.2.6/learn/glossary/#vnode
[bucket type]: {{<baseurl>}}riak/kv/3.2.6/developing/usage/bucket-types
[Riak data types]: {{<baseurl>}}riak/kv/3.2.6/developing/data-types
[strong consistency]: {{<baseurl>}}riak/kv/3.2.6/developing/app-guide/strong-consistency
...
The [Multi]({{<baseurl>}}riak/kv/3.2.6/setup/planning/backend/multi) backend does not
