...
toc: true
aliases:
  - /riak/3.2.6/dev/taste-of-riak/python
  - /riak/kv/3.2.6/dev/taste-of-riak/python
---
...
[CRUD Operations]({{<baseurl>}}riak/kv/3.2.6/developing/getting-started/python/crud-operations)
