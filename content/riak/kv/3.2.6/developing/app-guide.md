...
toc: true
aliases:
  - /riak/3.2.6/dev/using/application-guide/
  - /riak/kv/3.2.6/dev/using/application-guide/
---

[usage conflict resolution]: {{<baseurl>}}riak/kv/3.2.6/developing/usage/conflict-resolution
[dev data model#log]: {{<baseurl>}}riak/kv/3.2.6/developing/data-modeling/#log-data
[dev data model#sensor]: {{<baseurl>}}riak/kv/3.2.6/developing/data-modeling/#sensor-data
[concept eventual consistency]: {{<baseurl>}}riak/kv/3.2.6/learn/concepts/eventual-consistency
[dev data model#user]: {{<baseurl>}}riak/kv/3.2.6/developing/data-modeling/#user-data
...
[dev data types#counters]: {{<baseurl>}}riak/kv/3.2.6/developing/data-types/#counters
[dev data types#sets]: {{<baseurl>}}riak/kv/3.2.6/developing/data-types/#sets
[dev data types#maps]: {{<baseurl>}}riak/kv/3.2.6/developing/data-types/#maps
[usage create objects]: {{<baseurl>}}riak/kv/3.2.6/developing/usage/creating-objects
[usage search]: {{<baseurl>}}riak/kv/3.2.6/developing/usage/search
[use ref search]: {{<baseurl>}}riak/kv/3.2.6/using/reference/search
