...
[dev data model#log]: {{<baseurl>}}riak/kv/3.2.5/developing/data-modeling/#log-data
[dev data model#sensor]: {{<baseurl>}}riak/kv/3.2.5/developing/data-modeling/#sensor-data
[concept eventual consistency]: {{<baseurl>}}riak/kv/3.2.5/learn/concepts/eventual-consistency
[dev data model#user]: {{<baseurl>}}riak/kv/3.2.5/developing/data-modeling/#user-data
...
[dev data types#counters]: {{<baseurl>}}riak/kv/3.2.5/developing/data-types/#counters
[dev data types#sets]: {{<baseurl>}}riak/kv/3.2.5/developing/data-types/#sets
[dev data types#maps]: {{<baseurl>}}riak/kv/3.2.5/developing/data-types/#maps
[usage create objects]: {{<baseurl>}}riak/kv/3.2.5/developing/usage/creating-objects
[usage search]: {{<baseurl>}}riak/kv/3.2.5/developing/usage/search
[use ref search]: {{<baseurl>}}riak/kv/3.2.5/using/reference/search
