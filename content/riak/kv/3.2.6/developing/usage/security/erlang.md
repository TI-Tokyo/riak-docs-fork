...
If you are using [trust]({{<baseurl>}}riak/kv/3.2.5/using/security/managing-sources/), [PAM-]({{<baseurl>}}riak/kv/3.2.5/using/security/managing-sources/#pam-based-authentication), you can use the security setup described [below](#erlang-client-basics). [Password]({{<baseurl>}}riak/kv/3.2.5/using/security/managing-sources/#password-based-authentication)-based authentication is covered
...
on specifying trusted CIDRs can be found in [Trust-based Authentication]({{<baseurl>}}riak/kv/3.2.5/using/security/managing-sources/#trust-based-authentication).
