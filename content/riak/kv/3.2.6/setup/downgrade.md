...
toc: true
aliases:
  - /riak/3.2.6/ops/upgrading/rolling-downgrades/
  - /riak/kv/3.2.6/ops/upgrading/rolling-downgrades/
---

[rolling upgrade]: {{<baseurl>}}riak/kv/3.2.6/setup/upgrading/cluster
...
[aae status]: {{<baseurl>}}riak/kv/3.2.6/using/admin/riak-admin/#aae-status
...
If you enabled LZ4 compression in LevelDB and/or enabled global expiration in LevelDB when you installed KV 3.2.6, you cannot downgrade.
