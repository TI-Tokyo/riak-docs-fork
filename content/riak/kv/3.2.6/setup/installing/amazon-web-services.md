...
toc: true
aliases:
  - /riak/3.2.6/ops/building/installing/Installing-on-AWS-Marketplace
  - /riak/kv/3.2.6/ops/building/installing/Installing-on-AWS-Marketplace
  - /riak/3.2.6/installing/amazon-web-services/
  - /riak/kv/3.2.6/installing/amazon-web-services/
---
...
We also recommend that you read more about Riak's [Security and Firewalls]({{<baseurl>}}riak/kv/3.2.6/using/security/).
...
```bash
wget https://files.tiot.jp/riak/kv/3.2/3.2.6/amazon/2023/riak-3.2.6.OTP25-1.amzn2023.x86_64.rpm
sudo yum localinstall -y riak-3.2.6.OTP25-1.amzn2023.x86_64.rpm
```
...
```bash
wget https://files.tiot.jp/riak/kv/3.2/3.2.6/amazon/2023/riak-3.2.6.OTP25-1.amzn2023.x86_64.rpm
sudo rpm -i riak-3.2.6.OTP25-1.amzn2023.x86_64.rpm
```
