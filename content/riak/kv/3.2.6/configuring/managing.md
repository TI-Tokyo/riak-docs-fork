...
[use admin riak cli#chkconfig]: {{<baseurl>}}riak/kv/3.2.6/using/admin/riak-cli/#chkconfig

## Retrieving a Configuration Listing

**Note:** This command has been deprecated in Riak KV 3.2.6 onwards and will no longer function.
