...
{{% note %}}
Next Gen Replication relies on the TicTac AAE system, which needs to be enabled and configured. See the [TicTac AAE configuration][({{<baseurl>}}riak/kv/3.0.4/configuring/active-anti-entropy/tictac-aae/)] documentaion.
{{% /note %}}
