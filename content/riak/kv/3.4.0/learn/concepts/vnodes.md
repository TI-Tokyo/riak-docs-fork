...
toc: true
aliases:
  - /riak/3.4.0/theory/concepts/vnodes
  - /riak/kv/3.4.0/theory/concepts/vnodes
---

[concept causal context]: {{<baseurl>}}riak/kv/3.4.0/learn/concepts/causal-context
[concept clusters ring]: {{<baseurl>}}riak/kv/3.4.0/learn/concepts/clusters/#the-ring
...
subdirectories. If you're using, say, [Bitcask]({{<baseurl>}}riak/kv/3.4.0/setup/planning/backend/bitcask) as a backend, navigate
