...
toc: true
aliases:
  - /riak/3.4.0/theory/concepts/Buckets
  - /riak/kv/3.4.0/theory/concepts/Buckets
  - /riak/3.4.0/theory/concepts/buckets
  - /riak/kv/3.4.0/theory/concepts/buckets
---

[apps cluster metadata]: {{<baseurl>}}riak/kv/3.4.0/developing/app-guide/cluster-metadata
...
[concept causal context sib]: {{<baseurl>}}riak/kv/3.4.0/learn/concepts/causal-context/#siblings
...
[glossary ring]: {{<baseurl>}}riak/kv/3.4.0/learn/glossary/#ring
...
[usage replication]: {{<baseurl>}}riak/kv/3.4.0/developing/usage/replication
