...
toc: true
aliases:
  - /riak/3.4.0/theory/concepts/Eventual-Consistency
  - /riak/kv/3.4.0/theory/concepts/Eventual-Consistency
  - /riak/3.4.0/theory/concepts/eventual-consistency
  - /riak/kv/3.4.0/theory/concepts/eventual-consistency
---
...
special eventually consistent [Data Types]({{<baseurl>}}riak/kv/3.4.0/developing/data-types/), or you can resolve those
...
or models]({{<baseurl>}}riak/kv/3.4.0/developing/data-modeling/).
