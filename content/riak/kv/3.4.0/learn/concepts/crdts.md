...
toc: true
aliases:
  - /riak/3.4.0/theory/concepts/crdts
  - /riak/kv/3.4.0/theory/concepts/crdts
---

[crdts pdf]: http://hal.upmc.fr/docs/00/55/55/88/PDF/techreport.pdf
[data types converg]: {{<baseurl>}}riak/kv/3.4.0/learn/concepts/crdts/#convergence
[crdts reading list]: http://christophermeiklejohn.com/crdt/2014/07/22/readings-in-crdts.html
[data types impl]: {{<baseurl>}}riak/kv/3.4.0/learn/concepts/crdts/#implementation
[concept causal context dvv]: {{<baseurl>}}riak/kv/3.4.0/learn/concepts/causal-context/#dotted-version-vectors
...
[dev data types context]: {{<baseurl>}}riak/kv/3.4.0/developing/data-types/#data-types-and-context
