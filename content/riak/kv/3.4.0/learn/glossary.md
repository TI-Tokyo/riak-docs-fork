...
[concept causal context vc]: {{<baseurl>}}riak/kv/3.4.0/learn/concepts/causal-context/#vector-clocks
...
[concept strong consistency]: {{<baseurl>}}riak/kv/3.4.0/learn/concepts/strong-consistency
[dev kv model]: {{<baseurl>}}riak/kv/3.4.0/developing/key-value-modeling
[concept replication aae]: {{<baseurl>}}riak/kv/3.4.0/learn/concepts/replication/#active-anti-entropy
...
[learn dynamo]: {{<baseurl>}}riak/kv/3.4.0/learn/dynamo
[plan cluster capacity]: {{<baseurl>}}riak/kv/3.4.0/setup/planning/cluster-capacity
[repair recover failure recovery]: {{<baseurl>}}riak/kv/3.4.0/using/repair-recovery/failure-recovery
[repair recover repairs]: {{<baseurl>}}riak/kv/3.4.0/using/repair-recovery/repairs
...
[usage secondary-indexes]: {{<baseurl>}}riak/kv/3.4.0/developing/usage/secondary-indexes
...
* [Bucket Types]({{<baseurl>}}riak/kv/3.4.0/developing/usage/bucket-types)
