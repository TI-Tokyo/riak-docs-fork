...
toc: true
aliases:
  - /riak/3.4.0/ops/building/installing/installing-on-alpine-linux
  - /riak/kv/3.4.0/ops/building/installing/installing-on-alpine-linux
  - /riak/3.4.0/installing/alpine-linux/
  - /riak/kv/3.4.0/installing/alpine-linux/
---
...
4. Install Riak:
   ...
   * For version 3.4.0 using OTP 24, run `apk add riak=3.4.0.24-r1`
   * For version 3.4.0 using OTP 25, run `apk add riak=3.4.0.25-r1`
