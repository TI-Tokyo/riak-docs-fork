...
toc: true
aliases:
  - /riak/3.4.0/ops/building/planning/cluster
  - /riak/kv/3.4.0/ops/building/planning/cluster
---
...
[use admin riak admin#cluster]: {{<baseurl>}}riak/kv/3.4.0/using/admin/riak-admin/#cluster
