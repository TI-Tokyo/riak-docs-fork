---
title: "Upgrading to Riak KV 3.4.0"
description: ""
project: "riak_kv"
...
menu:
  riak_kv-3.4.0:
    name: "Upgrading to 3.4.0"
    identifier: "upgrading_version"
    weight: 101
    parent: "upgrading"
toc: true
aliases:
  - /riak/3.4.0/upgrade-v20/
  - /riak/kv/3.4.0/ops/upgrading/rolling-upgrades/
  - /riak/kv/3.4.0/ops/upgrading/rolling-upgrades/
  - /riak/kv/3.4.0/setup/upgrading/cluster/

---

[production checklist]: {{<baseurl>}}riak/kv/3.4.0/setup/upgrading/checklist
...
[release notes]: {{<baseurl>}}riak/kv/3.4.0/release-notes
...
[jmx monitor]: {{<baseurl>}}riak/kv/3.4.0/using/reference/jmx
[snmp]: {{<baseurl>}}riak/kv/3.4.0/using/reference/snmp
[Release Notes]: {{<baseurl>}}riak/kv/3.4.0/release-notes

## Overview

You can upgrade one node or your whole cluster to Riak KV 3.4.0 by following the instructions below.
