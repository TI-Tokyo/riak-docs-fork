...
version_history:
  in: "2.0.0-2.99.999"
aliases:
  - /riak/3.4.0/ops/upgrading/rolling-upgrades/
...
If you run [Riak Control]({{<baseurl>}}riak/kv/3.4.0/using/admin/riak-control), you should disable it during the rolling upgrade process.
{{% /note %}}
