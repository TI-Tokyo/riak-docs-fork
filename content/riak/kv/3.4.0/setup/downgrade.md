...
toc: true
aliases:
  - /riak/3.4.0/ops/upgrading/rolling-downgrades/
  - /riak/kv/3.4.0/ops/upgrading/rolling-downgrades/
---

[rolling upgrade]: {{<baseurl>}}riak/kv/3.4.0/setup/upgrading/cluster
...
[aae status]: {{<baseurl>}}riak/kv/3.4.0/using/admin/riak-admin/#aae-status
...
If you enabled LZ4 compression in LevelDB and/or enabled global expiration in LevelDB when you installed KV 3.4.0, you cannot downgrade.
