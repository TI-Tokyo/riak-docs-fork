...
toc: true
aliases:
  - /riak/3.4.0/ops/running/tools/riak
  - /riak/kv/3.4.0/ops/running/tools/riak
---

[configuration file]: {{<baseurl>}}riak/kv/3.4.0/configuring/reference/
[escript]: http://www.erlang.org/doc/man/escript.html
[`riak admin`]: {{<baseurl>}}riak/kv/3.4.0/using/admin/riak-admin/#top
[configuration]: {{<baseurl>}}riak/kv/3.4.0/configuring/reference/
...
In Riak KV 3.4.0, riak daemon replaces riak start.
...
In KV 3.4.0 the response to this command would appear as:
