...
toc: true
aliases:
  - /riak/3.4.0/ops/running/cluster-admin
  - /riak/kv/3.4.0/ops/running/cluster-admin
---
...
[use admin riak admin#cluster-plan]: {{<baseurl>}}riak/kv/3.4.0/using/admin/riak-admin/#cluster-plan
[use admin riak admin#cluster-commit]: {{<baseurl>}}riak/kv/3.4.0/using/admin/riak-admin/#cluster-commit
