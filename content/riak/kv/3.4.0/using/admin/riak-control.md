...
toc: true
aliases:
  - /riak/3.4.0/ops/advanced/riak-control
  - /riak/kv/3.4.0/ops/advanced/riak-control
---
...
enabled on each Riak node. For more information, see our [security documentation]({{<baseurl>}}riak/kv/3.4.0/using/security/basics#enabling-ssl). Once SSL is enabled, you can proceed to setting up [authentication](#authentication) for Riak Control.
...
see the health of each [vnode]({{<baseurl>}}riak/kv/3.4.0/learn/glossary/#vnode).
