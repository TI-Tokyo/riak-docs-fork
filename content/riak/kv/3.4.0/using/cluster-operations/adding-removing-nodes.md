...
toc: true
aliases:
  - /riak/3.4.0/ops/running/nodes/adding-removing
  - /riak/kv/3.4.0/ops/running/nodes/adding-removing
---
...
simply the script [`riak`]({{<baseurl>}}riak/kv/3.4.0/using/admin/riak-cli/):
