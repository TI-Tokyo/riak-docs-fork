...
toc: true
aliases:
  - /riak/3.4.0/ops/running/recovery/failure-recovery
  - /riak/kv/3.4.0/ops/running/recovery/failure-recovery
---
...
returns to service (also called [hinted handoff]({{<baseurl>}}riak/kv/3.4.0/learn/glossary/#hinted-handoff)).
...
See [Changing Cluster Information]({{<baseurl>}}riak/kv/3.4.0/using/cluster-operations/changing-cluster-info/#clusters-from-backups) for instructions on cluster recovery.
