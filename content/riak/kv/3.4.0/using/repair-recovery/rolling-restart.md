...
toc: true
aliases:
  - /riak/3.4.0/ops/running/recovery/rolling-restart
  - /riak/kv/3.4.0/ops/running/recovery/rolling-restart
---

Because Riak functions as a multi-node system, cluster-level [Riak version upgrades]({{<baseurl>}}riak/kv/3.4.0/setup/upgrading/cluster) and restarts can be performed on a node-by-node, "rolling" basis.
