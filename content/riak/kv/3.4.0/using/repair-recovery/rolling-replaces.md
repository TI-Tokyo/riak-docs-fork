...
[upgrade]: {{<baseurl>}}riak/kv/3.4.0/setup/upgrading/cluster/
[rolling restarts]: {{<baseurl>}}riak/kv/3.4.0/using/repair-recovery/rolling-restart/
[add node]: {{<baseurl>}}riak/kv/3.4.0/using/cluster-operations/adding-removing-nodes
