...
toc: true
aliases:
  - /riak/3.4.0/ops/building/benchmarking
  - /riak/kv/3.4.0/ops/building/benchmarking
---
...
* Erlang must be installed. See [Installing Erlang]({{<baseurl>}}riak/kv/3.4.0/setup/installing/source/erlang) for instructions
