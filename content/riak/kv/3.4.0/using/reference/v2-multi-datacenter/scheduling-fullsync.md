...
toc: true
aliases:
  - /riak/3.4.0/ops/mdc/v2/scheduling-fullsync
  - /riak/kv/3.4.0/ops/mdc/v2/scheduling-fullsync
---

{{% note title="Deprecation Warning" %}}
v2 Multi-Datacenter Replication is deprecated and will be removed in a future version. Please use [v3]({{<baseurl>}}riak/kv/3.4.0/using/reference/v3-multi-datacenter/scheduling-fullsync/) instead.
{{% /note %}}
