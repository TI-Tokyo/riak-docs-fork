...
toc: true
aliases:
  - /riak/3.4.0/dev/advanced/2i
  - /riak/kv/3.4.0/dev/advanced/2i
---
...
[secondary indexes]({{<baseurl>}}riak/kv/3.4.0/developing/usage/secondary-indexes/) \(2i) feature.

## How It Works

Secondary indexes use **document-based partitioning**, a system where
indexes reside with each document, local to the [vnode]({{<baseurl>}}riak/kv/3.4.0/learn/glossary/#vnode). This
...
changed [using bucket types][usage bucket types], which manage buckets' [replication properties]({{<baseurl>}}riak/kv/3.4.0/developing/app-guide/replication-properties). The system is capable of generating a full set of results
