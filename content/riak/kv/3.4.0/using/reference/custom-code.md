...
toc: true
aliases:
  - /riak/3.4.0/ops/advanced/install-custom-code/
  - /riak/kv/3.4.0/ops/advanced/install-custom-code/
---

Riak supports the use of Erlang named functions in compiled modules for
[pre/post-commit hooks]({{<baseurl>}}riak/kv/3.4.0/developing/usage/commit-hooks), and MapReduce operations. This
doc contains installation steps with simple examples for each use case.

Your developers can compile [custom erlang code]({{<baseurl>}}riak/kv/3.4.0/developing/usage/commit-hooks), which
...
in the [Commands documentation]({{<baseurl>}}riak/kv/3.4.0/using/admin/riak-admin/#wait-for-service).
