...
aliases:
  - /riak/3.4.0/ops/mdc/v3/cascading-writes
  - /riak/kv/3.4.0/ops/mdc/v3/cascading-writes
---
...
`riak repl` command. Please see the [Version 3 Operations guide]({{<baseurl>}}riak/kv/3.4.0/using/cluster-operations/v3-multi-datacenter) for more information.
