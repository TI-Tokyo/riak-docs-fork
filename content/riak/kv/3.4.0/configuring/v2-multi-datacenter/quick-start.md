...
aliases:
  - /riak/3.4.0/ops/mdc/v2/quick-start
  - /riak/kv/3.4.0/ops/mdc/v2/quick-start
---

{{% note title="Deprecation Warning" %}}
v2 Multi-Datacenter Replication is deprecated and will be removed in a future version. Please use [v3]({{<baseurl>}}riak/kv/3.4.0/configuring/v3-multi-datacenter/quick-start/) instead.
{{% /note %}}
