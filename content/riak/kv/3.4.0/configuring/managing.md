...
[use admin riak cli#chkconfig]: {{<baseurl>}}riak/kv/3.4.0/using/admin/riak-cli/#chkconfig

## Retrieving a Configuration Listing

**Note:** This command has been deprecated in Riak KV 3.4.0 onwards and will no longer function.
