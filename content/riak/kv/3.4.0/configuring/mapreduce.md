...
toc: true
aliases:
  - /riak/3.4.0/ops/advanced/configs/mapreduce/
  - /riak/kv/3.4.0/ops/advanced/configs/mapreduce/
---

[usage mapreduce]: {{<baseurl>}}riak/kv/3.4.0/developing/usage/mapreduce
[config reference#appconfig]: {{<baseurl>}}riak/kv/3.4.0/configuring/reference/#app-config
