...
toc: true
aliases:
  - /riak/3.4.0/dev/using/conflict-resolution/golang
  - /riak/kv/3.4.0/dev/using/conflict-resolution/golang
---

For reasons explained in the [Introduction to conflict resolution]({{<baseurl>}}riak/kv/3.4.0/developing/usage/conflict-resolution), we strongly recommend adopting a conflict resolution strategy that
