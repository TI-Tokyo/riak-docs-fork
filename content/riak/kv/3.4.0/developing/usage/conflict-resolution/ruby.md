...
toc: true
aliases:
  - /riak/3.4.0/dev/using/conflict-resolution/ruby
  - /riak/kv/3.4.0/dev/using/conflict-resolution/ruby
---
...
the official Ruby client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}riak/kv/3.4.0/developing/usage) section.
