...
toc: true
aliases:
  - /riak/3.4.0/dev/using/conflict-resolution/php
  - /riak/kv/3.4.0/dev/using/conflict-resolution/php
---
...
the official PHP client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}riak/kv/3.4.0/developing/usage) section.
