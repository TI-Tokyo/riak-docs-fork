...
you first fetch the [causal context]({{<baseurl>}}riak/kv/3.4.0/learn/concepts/causal-context) of the object prior to updating.
This can be done by setting the `deletedvclock` parameter to `true` as
part of the [fetch operation]({{<baseurl>}}riak/kv/3.4.0/developing/api/protocol-buffers/fetch-object). This can also be done
