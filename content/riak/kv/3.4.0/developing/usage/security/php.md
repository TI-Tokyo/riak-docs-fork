...
toc: true
aliases:
  - /riak/3.4.0/dev/advanced/client-security/php
  - /riak/kv/3.4.0/dev/advanced/client-security/php
---

This tutorial shows you how to set up a Riak PHP client to authenticate
itself when connecting to Riak.

If you are using [trust-]({{<baseurl>}}riak/kv/3.4.0/using/security/managing-sources/#trust-based-authentication) or [PAM]({{<baseurl>}}riak/kv/3.4.0/using/security/managing-sources/#pam-based-authentication)-based authentication, you can use the
security setup described [below](#php-client-basics). [Certificate]({{<baseurl>}}riak/kv/3.4.0/using/security/managing-sources/#certificate-based-authentication)-based authentication is not
...
regardless of which [security source]({{<baseurl>}}riak/kv/3.4.0/using/security/managing-sources/) you choose. All clients should also provide a username, regardless of
