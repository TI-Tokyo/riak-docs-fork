...
toc: true
aliases:
  - /riak/3.4.0/dev/advanced/client-security/java
  - /riak/kv/3.4.0/dev/advanced/client-security/java
---
...
security setup described [below](#java-client-basics). [Certificate]({{<baseurl>}}riak/kv/3.4.0/using/security/managing-sources/#certificate-based-authentication)-based authentication is not
