...
toc: true
aliases:
  - /riak/3.4.0/dev/using/mapreduce
  - /riak/kv/3.4.0/dev/using/mapreduce
---
...
[usage types]: {{<baseurl>}}riak/kv/3.4.0/developing/usage/bucket-types
[api http]: {{<baseurl>}}riak/kv/3.4.0/developing/api/http
[api pb]: {{<baseurl>}}riak/kv/3.4.0/developing/api/protocol-buffers
[glossary vnode]: {{<baseurl>}}riak/kv/3.4.0/learn/glossary/#vnode
[guide mapreduce]: {{<baseurl>}}riak/kv/3.4.0/developing/app-guide/advanced-mapreduce
