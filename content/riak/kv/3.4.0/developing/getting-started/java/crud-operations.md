...
Riak, see [Updating Objects]({{<baseurl>}}riak/kv/3.4.0/developing/usage/updating-objects/)
and [Conflict Resolution]({{<baseurl>}}riak/kv/3.4.0/developing/usage/conflict-resolution/)
documentation.
