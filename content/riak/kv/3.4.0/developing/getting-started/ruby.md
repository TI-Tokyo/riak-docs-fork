...
toc: true
aliases:
  - /riak/3.4.0/dev/taste-of-riak/ruby
  - /riak/kv/3.4.0/dev/taste-of-riak/ruby
---

If you haven't set up a Riak Node and started it, please visit [Running A Cluster]({{<baseurl>}}riak/kv/3.4.0/using/running-a-cluster) first. To try this flavor
...
[CRUD Operations]({{<baseurl>}}riak/kv/3.4.0/developing/getting-started/ruby/crud-operations)
