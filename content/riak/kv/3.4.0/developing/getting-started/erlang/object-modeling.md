...
toc: true
aliases:
  - /riak/3.4.0/dev/taste-of-riak/object-modeling-erlang
  - /riak/kv/3.4.0/dev/taste-of-riak/object-modeling-erlang
---
...
We'll be using the bucket `Users` to store our data. We won't be [using bucket types]({{<baseurl>}}riak/kv/3.4.0/developing/usage/bucket-types) here, so we don't need to specify one.
