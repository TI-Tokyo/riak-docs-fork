...
toc: true
aliases:
  - /riak/3.4.0/dev/taste-of-riak/querying-erlang
  - /riak/kv/3.4.0/dev/taste-of-riak/querying-erlang
---
...
A more comprehensive discussion can be found in [Key/Value Modeling]({{<baseurl>}}riak/kv/3.4.0/developing/key-value-modeling).
...
{{% note %}}
Secondary indexes in Riak KV require a sorted backend: [Memory]({{<baseurl>}}riak/kv/3.4.0/setup/planning/backend/memory) or [LevelDB]({{<baseurl>}}riak/kv/3.4.0/setup/planning/backend/leveldb). [Bitcask]({{<baseurl>}}riak/kv/3.4.0/setup/planning/backend/bitcask) does not support secondary indexes.

See [Using Secondary Indexes (2i)]({{<baseurl>}}riak/kv/3.4.0/developing/usage/secondary-indexes) for more information on developing with secondary indexes.
{{% /note %}}
