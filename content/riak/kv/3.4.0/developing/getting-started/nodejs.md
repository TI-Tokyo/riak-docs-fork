...
toc: true
aliases:
  - /riak/3.4.0/dev/taste-of-riak/nodejs
  - /riak/kv/3.4.0/dev/taste-of-riak/nodejs
---
...
If you haven't set up a Riak Node and started it, please visit [Running A Cluster]({{<baseurl>}}riak/kv/3.4.0/using/running-a-cluster) first.
...
[CRUD Operations]({{<baseurl>}}riak/kv/3.4.0/developing/getting-started/nodejs/crud-operations)
