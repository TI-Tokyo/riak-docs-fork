...
toc: true
aliases:
  - /riak/3.4.0/dev/taste-of-riak/python
  - /riak/kv/3.4.0/dev/taste-of-riak/python
---
...
[CRUD Operations]({{<baseurl>}}riak/kv/3.4.0/developing/getting-started/python/crud-operations)
