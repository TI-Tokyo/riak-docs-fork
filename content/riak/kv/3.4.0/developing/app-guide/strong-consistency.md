...
toc: true
aliases:
  - /riak/3.4.0/dev/advanced/strong-consistency
  - /riak/kv/3.4.0/dev/advanced/strong-consistency
---
...
[use ref strong consistency#trade-offs]: {{<baseurl>}}riak/kv/3.4.0/using/reference/strong-consistency/#trade-offs
[glossary vnode]: {{<baseurl>}}riak/kv/3.4.0/learn/glossary/#vnode
[config strong consistency#enable]: {{<baseurl>}}riak/kv/3.4.0/configuring/strong-consistency/#enabling-strong-consistency
...
[config strong consistency#fault]: {{<baseurl>}}riak/kv/3.4.0/configuring/strong-consistency/#fault-tolerance
[concept causal context]: {{<baseurl>}}riak/kv/3.4.0/learn/concepts/causal-context
[concept causal context#vector]: {{<baseurl>}}riak/kv/3.4.0/learn/concepts/causal-context/#vector-clocks
[concept version vector]: {{<baseurl>}}riak/kv/3.4.0/learn/concepts/causal-context/#dotted-version-vectors
...
[use ref strong consistency#vs]: {{<baseurl>}}riak/kv/3.4.0/using/reference/strong-consistency/#strong-vs.-eventual-consistency
...
[config strong consistency#details]: {{<baseurl>}}riak/kv/3.4.0/configuring/strong-consistency/#implementation-details
