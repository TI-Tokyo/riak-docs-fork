...
version_history:
  in: "2.1.0+"
aliases:
  - /riak/3.4.0/dev/advanced/write-once
  - /riak/kv/3.4.0/dev/advanced/write-once
---

[glossary vnode]: {{<baseurl>}}riak/kv/3.4.0/learn/glossary/#vnode
[bucket type]: {{<baseurl>}}riak/kv/3.4.0/developing/usage/bucket-types
[Riak data types]: {{<baseurl>}}riak/kv/3.4.0/developing/data-types
[strong consistency]: {{<baseurl>}}riak/kv/3.4.0/developing/app-guide/strong-consistency
...
The [Multi]({{<baseurl>}}riak/kv/3.4.0/setup/planning/backend/multi) backend does not
