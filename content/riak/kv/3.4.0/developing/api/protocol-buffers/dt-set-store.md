...
toc: true
aliases:
  - /riak/3.4.0/dev/references/protocol-buffers/dt-set-store
  - /riak/kv/3.4.0/dev/references/protocol-buffers/dt-set-store
---

An operation to update a set, either on its own (at the bucket/key
level) or [inside of a map]({{<baseurl>}}riak/kv/3.4.0/developing/api/protocol-buffers/dt-map-store).
