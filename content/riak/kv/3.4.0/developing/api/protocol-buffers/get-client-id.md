...
toc: true
aliases:
  - /riak/3.4.0/dev/references/protocol-buffers/get-client-id
  - /riak/kv/3.4.0/dev/references/protocol-buffers/get-client-id
---
...
connected and can be changed using [Set Client ID]({{<baseurl>}}riak/kv/3.4.0/developing/api/protocol-buffers/set-client-id).
