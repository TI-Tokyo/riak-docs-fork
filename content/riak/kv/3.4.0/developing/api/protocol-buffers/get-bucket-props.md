...
toc: true
aliases:
  - /riak/3.4.0/dev/references/protocol-buffers/get-bucket-props
  - /riak/kv/3.4.0/dev/references/protocol-buffers/get-bucket-props
---
...
The bucket's name (`bucket`) must be specified. The [bucket type]({{<baseurl>}}riak/kv/3.4.0/using/cluster-operations/bucket-types) parameter (`type`) is optional. If it is not specified,
...
[configuration file]({{<baseurl>}}riak/kv/3.4.0/configuring/reference/#default-bucket-properties) documentation.
