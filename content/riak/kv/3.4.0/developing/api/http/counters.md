...
toc: true
aliases:
  - /riak/3.4.0/dev/references/http/counters
  - /riak/kv/3.4.0/dev/references/http/counters
---
...
The regular POST/PUT ([HTTP Store Object]({{<baseurl>}}riak/kv/3.4.0/developing/api/http/store-object)) and GET ([HTTP Fetch Object]({{<baseurl>}}riak/kv/3.4.0/developing/api/http/fetch-object)) responses apply here.
