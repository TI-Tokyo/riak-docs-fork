...
toc: true
aliases:
  - /riak/3.4.0/dev/references/http/link-walking
  - /riak/kv/3.4.0/dev/references/http/link-walking
---
...
is a special case of [MapReduce]({{<baseurl>}}riak/kv/3.4.0/developing/usage/mapreduce), and can be expressed more verbosely as such.
[Read more about Links]({{<baseurl>}}riak/kv/3.4.0/learn/glossary/#links).
...
response from [fetching the object]({{<baseurl>}}riak/kv/3.4.0/developing/api/http/fetch-object), without the status
code.
