...
{{% note %}}
Next Gen Replication relies on the TicTac AAE system, which needs to be enabled and configured. See the [TicTac AAE configuration]({{<baseurl>}}riak/kv/2.9.9/configuring/active-anti-entropy/tictac-aae/) documentaion.
{{% /note %}}
