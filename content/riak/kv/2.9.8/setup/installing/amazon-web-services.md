...
```bash
wget https://files.tiot.jp/riak/kv/2.2/3.0.2/amazon/2/riak-3.0.2-1.amzn2x86_64.rpm
...
```bash
wget https://files.tiot.jp/riak/kv/2.2/3.0.2/amazon/2016.09/riak-3.0.2-1.amzn1x86_64.rpm
