...
(in LevelDB LOG files) Compaction error | Turn off the node and run repair on the LevelDB partition. See <a href="See <a href="{{< baseurl >}}riak/kv/2.1.4/using/repair-recovery/errors/#more">Step 2</a>.
