...
aliases:
  ...
  - /riak/kv/3.2.4/ops/advanced/install-custom-code/
---

Riak supports the use of Erlang named functions in compiled modules for
[pre/post-commit hooks]({{<baseurl>}}riak/kv/3.2.4/developing/usage/commit-hooks), and MapReduce operations. This
doc contains installation steps with simple examples for each use case.

Your developers can compile [custom erlang code]({{<baseurl>}}riak/kv/3.2.4/developing/usage/commit-hooks), which
...
in the [Commands documentation]({{<baseurl>}}riak/kv/3.2.4/using/admin/riak-admin/#wait-for-service).
