...
v2 Multi-Datacenter Replication is deprecated and will be removed in a future version. Please use [v3]({{<baseurl>}}riak/kv/3.2.4/using/reference/v3-multi-datacenter/) instead.
{{% /note %}}
