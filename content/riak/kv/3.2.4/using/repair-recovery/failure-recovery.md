...
aliases:
  ...
  - /riak/kv/3.2.4/ops/running/recovery/failure-recovery
---
...
returns to service (also called [hinted handoff]({{<baseurl>}}riak/kv/3.2.4/learn/glossary/#hinted-handoff)).
...
See [Changing Cluster Information]({{<baseurl>}}riak/kv/3.2.4/using/cluster-operations/changing-cluster-info/#clusters-from-backups) for instructions on cluster recovery.
