...
aliases:
  ...
  - /riak/kv/3.2.4/ops/running/recovery/repairing-indexes
  ...
  - /riak/kv/3.2.4/ops/running/recovery/repairing-leveldb
  - /riak/3.2.4/ops/running/recovery/repairing-partitions
  - /riak/kv/3.2.4/ops/running/recovery/repairing-partitions
---

[cluster ops aae]: {{<baseurl>}}riak/kv/3.2.4/using/cluster-operations/active-anti-entropy/
[config ref]: {{<baseurl>}}riak/kv/3.2.4/configuring/reference/
...
[glossary readrep]: {{<baseurl>}}riak/kv/3.2.4/learn/glossary/#read-repair
[tiered storage]: {{<baseurl>}}riak/kv/3.2.4/setup/planning/backend/leveldb/#tiered-storage
...
[partitions]({{<baseurl>}}riak/kv/3.2.4/learn/concepts/clusters/#the-ring). Repairs of Riak KV data are typically
...
repair data will depend mainly on your use case and on whether [active anti-entropy]({{<baseurl>}}riak/kv/3.2.4/learn/concepts/active-anti-entropy/) is enabled.

You will need to run a repair if the following are both true:

* Active anti-entropy is [disabled]({{<baseurl>}}riak/kv/3.2.4/learn/concepts/active-anti-entropy/#disabling-active-anti-entropy)
* You have both non-expiring data and keys that are not accessed
  ...
  [read repair]({{<baseurl>}}riak/kv/3.2.4/learn/concepts/active-anti-entropy/#read-repair-vs-active-anti-entropy))

You will most likely not need to run a repair operation if _any_ of the
following is true:

* Active anti-entropy is [enabled]({{<baseurl>}}riak/kv/3.2.4/learn/concepts/active-anti-entropy/#enabling-active-anti-entropy)
