...
aliases:
  ...
  - /riak/kv/3.2.4/dev/using/conflict-resolution/php
---
...
the official PHP client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}riak/kv/3.2.4/developing/usage) section.
