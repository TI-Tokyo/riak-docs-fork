...
aliases:
  ...
  - /riak/kv/3.2.4/dev/advanced/client-security/java
---
...
security setup described [below](#java-client-basics). [Certificate]({{<baseurl>}}riak/kv/3.2.4/using/security/managing-sources/#certificate-based-authentication)-based authentication is not
