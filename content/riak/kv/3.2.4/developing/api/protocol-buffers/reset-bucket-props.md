...
aliases:
  ...
  - /riak/kv/3.2.4/dev/references/protocol-buffers/reset-bucket-props
---
...
[bucket type]({{<baseurl>}}riak/kv/3.2.4/developing/usage/bucket-types) using the `type` value. If you do not
