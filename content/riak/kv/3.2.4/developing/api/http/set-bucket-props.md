...
aliases:
  ...
  - /riak/kv/3.2.4/dev/references/http/set-bucket-props
---
...
clock) when writing
* `precommit` - [precommit hooks]({{<baseurl>}}riak/kv/3.2.4/developing/usage/commit-hooks)
* `postcommit` - [postcommit hooks]({{<baseurl>}}riak/kv/3.2.4/developing/usage/commit-hooks)
