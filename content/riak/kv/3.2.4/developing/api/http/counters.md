...
aliases:
  ...
  - /riak/kv/3.2.4/dev/references/http/counters
---
...
The regular POST/PUT ([HTTP Store Object]({{<baseurl>}}riak/kv/3.2.4/developing/api/http/store-object)) and GET ([HTTP Fetch Object]({{<baseurl>}}riak/kv/3.2.4/developing/api/http/fetch-object)) responses apply here.
