...
aliases:
  ...
  - /riak/kv/3.2.4/ops/upgrading/rolling-downgrades/
---

[rolling upgrade]: {{<baseurl>}}riak/kv/3.2.4/setup/upgrading/cluster
...
[aae status]: {{<baseurl>}}riak/kv/3.2.4/using/admin/riak-admin/#aae-status
