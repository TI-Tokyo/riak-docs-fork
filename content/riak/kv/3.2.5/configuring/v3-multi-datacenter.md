...
aliases:
  - /riak/3.2.6/ops/mdc/v3/configuration
  - /riak/kv/3.2.6/ops/mdc/v3/configuration
---

[config reference#advanced]: {{<baseurl>}}riak/kv/3.2.6/configuring/reference/#advanced-configuration
[config v3 ssl#verify-peer]: {{<baseurl>}}riak/kv/3.2.6/configuring/v3-multi-datacenter/ssl/#verifying-peer-certificates
