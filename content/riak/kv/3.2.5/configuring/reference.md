...
toc: true
aliases:
  - /riak/3.2.6/ops/advanced/configs/configuration-files/
  - /riak/kv/3.2.6/ops/advanced/configs/configuration-files/
search_boost: 10
---
...
as <a href="{{< baseurl >}}riak/kv/3.2.6/learn/glossary/#active-anti-entropy-aae">active anti-entropy</a> data, and cluster metadata.</td>
...
associated <a href="{{< baseurl >}}riak/kv/3.2.6/learn/glossary/#vnode">vnode</a> before assuming that the vnode
...
href="{{< baseurl >}}riak/kv/3.2.6/learn/glossary/#vnode">vnodes</a> attempt to trigger <a
href="{{< baseurl >}}riak/kv/3.2.6/learn/glossary/#hinted-handoff">handoff</a> between
...
%% to release 3.2.6 it was set to a default of 10.</td>
<td><code>5</code><td>
</try>
