...
toc: true
aliases:
  - /riak/3.2.6/theory/concepts/Replication
  - /riak/kv/3.2.6/theory/concepts/Replication
  - /riak/3.2.6/theory/concepts/replication
  - /riak/kv/3.2.6/theory/concepts/replication
keywords: "nval n_val"
---
...
[glossary ring]: {{<baseurl>}}riak/kv/3.2.6/learn/glossary/#ring
...
bucket's [bucket type]({{<baseurl>}}riak/kv/3.2.6/developing/usage/bucket-types).
...
[Multi-Datacenter Replications]({{<baseurl>}}riak/kv/3.2.6/configuring/planning/v3-multi-datacenter) capabilities.
...
type]({{<baseurl>}}riak/kv/3.2.6/developing/usage/bucket-types) with `n_val` set to your desired value and
...
queries, e.g. [secondary index]({{<baseurl>}}riak/kv/3.2.6/developing/usage/secondary-indexes/) and
[MapReduce]({{<baseurl>}}riak/kv/3.2.6/developing/usage/mapreduce/) queries. Lowering an object or bucket's
