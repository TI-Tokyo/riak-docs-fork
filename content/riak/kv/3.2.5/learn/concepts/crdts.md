...
[data types converg]: {{<baseurl>}}riak/kv/3.2.5/learn/concepts/crdts/#convergence
[crdts reading list]: http://christophermeiklejohn.com/crdt/2014/07/22/readings-in-crdts.html
[data types impl]: {{<baseurl>}}riak/kv/3.2.5/learn/concepts/crdts/#implementation
[concept causal context dvv]: {{<baseurl>}}riak/kv/3.2.5/learn/concepts/causal-context/#dotted-version-vectors
[concept causal context sib]: {{<baseurl>}}riak/kv/3.2.5/learn/concepts/causal-context/#siblings
...
[concept strong consistency]: {{<baseurl>}}riak/kv/3.2.5/learn/concepts/strong-consistency
[dev data types]: {{<baseurl>}}riak/kv/3.2.5/developing/data-types
[riak_dt]: https://github.com/basho/riak_dt
[dev data types context]: {{<baseurl>}}riak/kv/3.2.5/developing/data-types/#data-types-and-context
