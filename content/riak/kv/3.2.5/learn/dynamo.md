...
toc: false
aliases:
  - /riak/3.2.6/theory/dynamo
  - /riak/kv/3.2.6/theory/dynamo
---
...
[Consistent Hashing]: {{<baseurl>}}riak/kv/3.2.6/learn/glossary/#consistent-hashing
[Gossip Protocol]: {{<baseurl>}}riak/kv/3.2.6/learn/glossary/#gossiping
...
[HTTP API]: {{<baseurl>}}riak/kv/3.2.6/developing/api/http/
[Protocol Buffers API]: {{<baseurl>}}riak/kv/3.2.6/developing/api/protocol-buffers/
...
[Further Reading on Partitioning in Riak KV]: {{<baseurl>}}riak/kv/3.2.6/learn/concepts/clusters/
[All about the Riak KV Ring]: {{<baseurl>}}riak/kv/3.2.6/learn/concepts/clusters/#the-ring
...
>
> [Vector Clock on Riak KV Glossary]({{<baseurl>}}riak/kv/3.2.6/learn/glossary/#vector-clock)
>
...
>
>[REST API]({{<baseurl>}}riak/kv/3.2.6/developing/api/http/)
>
>[Writing Data]({{<baseurl>}}riak/kv/3.2.6/developing/usage/creating-objects/)
>
>[Reading Data]({{<baseurl>}}riak/kv/3.2.6/developing/usage/reading-objects/)
...
> [Read Repair]({{<baseurl>}}riak/kv/3.2.6/learn/concepts/replication/#read-repair).
...
[Hinted handoff]: {{<baseurl>}}riak/kv/3.2.6/learn/glossary/#hinted-handoff
[Replication]: {{<baseurl>}}riak/kv/3.2.6/developing/usage/replication/
...
[Multi Datacenter Replication]: {{<baseurl>}}riak/kv/3.2.6/using/reference/v3-multi-datacenter/architecture/
...
[Adding and Removing Nodes]: {{<baseurl>}}riak/kv/3.2.6/using/cluster-operations/adding-removing-nodes/
[Failure Scenarios]: {{<baseurl>}}riak/kv/3.2.6/learn/concepts/eventual-consistency/
...
[riak admin command-line tool]: {{<baseurl>}}riak/kv/3.2.6/using/admin/riak-admin/
...
[gossiping]: {{<baseurl>}}riak/kv/3.2.6/learn/glossary/#gossiping
...
[The Node Join Process]: {{<baseurl>}}riak/kv/3.2.6/using/cluster-operations/adding-removing-nodes/#joining-nodes-to-form-a-cluster
...
[backend options]: {{<baseurl>}}riak/kv/3.2.6/setup/planning/backend/
[Bitcask]: {{<baseurl>}}riak/kv/3.2.6/setup/planning/backend/bitcask/
[LevelDB]: {{<baseurl>}}riak/kv/3.2.6/setup/planning/backend/leveldb/
[Memory]: {{<baseurl>}}riak/kv/3.2.6/setup/planning/backend/memory/
[secondary indexes]: {{<baseurl>}}riak/kv/3.2.6/developing/usage/secondary-indexes/
...
[Basho Bench]: {{<baseurl>}}riak/kv/3.2.6/using/performance/benchmarking/
...
[CRDTs (Commutative Replicated Data Types)]: {{<baseurl>}}riak/kv/3.2.6/developing/data-types/
...
[partitioning]: {{<baseurl>}}riak/kv/3.2.6/learn/concepts/replication/#understanding-replication-by-example
...
[The Node Join Process]: {{<baseurl>}}riak/kv/3.2.6/using/cluster-operations/adding-removing-nodes/#joining-nodes-to-form-a-cluster
[Replacing a Node]: {{<baseurl>}}riak/kv/3.2.6/using/cluster-operations/replacing-node/
...
[Load Balancing]: {{<baseurl>}}riak/kv/3.2.6/configuring/load-balancing-proxy/
...
[client libraries]: {{<baseurl>}}riak/kv/3.2.6/developing/client-libraries/
