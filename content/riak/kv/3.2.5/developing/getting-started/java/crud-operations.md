...
Riak, see [Updating Objects]({{<baseurl>}}riak/kv/3.2.6/developing/usage/updating-objects/)
and [Conflict Resolution]({{<baseurl>}}riak/kv/3.2.6/developing/usage/conflict-resolution/)
documentation.
