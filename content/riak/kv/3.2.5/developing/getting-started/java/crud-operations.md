...
Riak, see [Updating Objects]({{<baseurl>}}riak/kv/3.2.5/developing/usage/updating-objects/)
and [Conflict Resolution]({{<baseurl>}}riak/kv/3.2.5/developing/usage/conflict-resolution/)
documentation.
