...
toc: true
aliases:
  - /riak/3.2.6/dev/references/protocol-buffers/set-bucket-props
  - /riak/kv/3.2.6/dev/references/protocol-buffers/set-bucket-props
---
...
[PBC Get Bucket Properties]({{<baseurl>}}riak/kv/3.2.6/developing/api/protocol-buffers/get-bucket-props) documentation.

You can also specify a [bucket type]({{<baseurl>}}riak/kv/3.2.6/developing/usage/bucket-types) using the
