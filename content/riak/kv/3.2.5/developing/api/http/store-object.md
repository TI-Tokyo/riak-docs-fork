...
[Read more about Secondary Indexing]({{<baseurl>}}riak/kv/3.2.5/developing/api/http/secondary-indexes)
* `Link` - user and system-defined links to other resources. [Read more about Links.]({{<baseurl>}}riak/kv/3.2.5/developing/api/http/link-walking)
...
If `returnbody=true`, any of the response headers expected from [HTTP Fetch Object]({{<baseurl>}}riak/kv/3.2.5/developing/api/http/fetch-object) may be present. Like when fetching the object, `300 Multiple Choices`
