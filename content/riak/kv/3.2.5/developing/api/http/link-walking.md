...
toc: true
aliases:
  - /riak/3.2.6/dev/references/http/link-walking
  - /riak/kv/3.2.6/dev/references/http/link-walking
---
...
is a special case of [MapReduce]({{<baseurl>}}riak/kv/3.2.6/developing/usage/mapreduce), and can be expressed more verbosely as such.
[Read more about Links]({{<baseurl>}}riak/kv/3.2.6/learn/glossary/#links).
...
response from [fetching the object]({{<baseurl>}}riak/kv/3.2.6/developing/api/http/fetch-object), without the status
code.
