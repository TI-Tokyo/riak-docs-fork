...
toc: true
aliases:
  - /riak/3.2.6/dev/references/http/set-bucket-props
  - /riak/kv/3.2.6/dev/references/http/set-bucket-props
---
...
clock) when writing
* `precommit` - [precommit hooks]({{<baseurl>}}riak/kv/3.2.6/developing/usage/commit-hooks)
* `postcommit` - [postcommit hooks]({{<baseurl>}}riak/kv/3.2.6/developing/usage/commit-hooks)
