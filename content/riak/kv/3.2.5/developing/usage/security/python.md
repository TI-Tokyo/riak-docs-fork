...
toc: true
aliases:
  - /riak/3.2.6/dev/advanced/client-security/python
  - /riak/kv/3.2.6/dev/advanced/client-security/python
---

This tutorial shows you how to set up a Riak Python client to
authenticate itself when connecting to Riak.

If you are using [trust-]({{<baseurl>}}riak/kv/3.2.6/using/security/managing-sources/) or [PAM-]({{<baseurl>}}riak/kv/3.2.6/using/security/managing-sources/#pam-based-authentication), you can use the security
setup described [below](#python-client-basics). [Password]({{<baseurl>}}riak/kv/3.2.6/using/security/managing-sources/#password-based-authentication)-based authentication is covered
in a [later section](#password-based-authentication). If you are using
[certificate]({{<baseurl>}}riak/kv/3.2.6/using/security/managing-sources/#certificate-based-authentication)-based authentication, follow
...
regardless of which [security source]({{<baseurl>}}riak/kv/3.2.6/using/security/managing-sources/) you
...
Authentication]({{<baseurl>}}riak/kv/3.2.6/using/security/managing-sources/#Trust-based-Authentication).
...
To specify a list of preferred [security ciphers]({{<baseurl>}}riak/kv/3.2.6/using/security/basics/#security-ciphers), you can pass in a colon-delimited
