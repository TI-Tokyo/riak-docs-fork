...
<a href="{{< baseurl >}}riak/kv/3.2.5/using/reference/strong-consistency/">strongly
...
<a href="{{< baseurl >}}riak/kv/3.2.5/developing/app-guide/strong-consistency/">Using
...
documentation on [Bitcask][plan backend bitcask], [LevelDB][plan backend leveldb], and [multiple backends]({{<baseurl>}}riak/kv/3.2.5/setup/planning/backend/multi).
...
refer to the tutorial on [basic key/value operations in Riak KV]({{<baseurl>}}riak/kv/3.2.5/developing/getting-started)
