...
toc: true
aliases:
  - /riak/3.2.6/dev/using/conflict-resolution/java
  - /riak/kv/3.2.6/dev/using/conflict-resolution/java
---
...
[bucket type]({{<baseurl>}}riak/kv/3.2.6/developing/usage/bucket-types) `siblings`, and for this bucket type
...
the official Java client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}riak/kv/3.2.6/developing/usage) section.
