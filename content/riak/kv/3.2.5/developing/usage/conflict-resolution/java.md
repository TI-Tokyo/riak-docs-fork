...
[bucket type]({{<baseurl>}}riak/kv/3.2.5/developing/usage/bucket-types) `siblings`, and for this bucket type
...
the official Java client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}riak/kv/3.2.5/developing/usage) section.
