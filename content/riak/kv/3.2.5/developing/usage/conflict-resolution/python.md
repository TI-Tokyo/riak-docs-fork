...
For reasons explained in the [Introduction to conflict resolution]({{<baseurl>}}riak/kv/3.2.5/developing/usage/conflict-resolution), we strongly recommend adopting a
...
application will be stored in buckets that bear the [bucket type]({{<baseurl>}}riak/kv/3.2.5/developing/usage/bucket-types) `siblings`, and for this bucket type `allow_mult` is set
...
from the official Python client library, in the [Developing with Riak KV: Usage]({{<baseurl>}}riak/kv/3.2.5/developing/usage) section.
...
resolution is that Riak offers a variety of [Data Types]({{<baseurl>}}riak/kv/3.2.5/developing/data-types/) that have
specific conflict resolution mechanics built in. If you have data that
can be modeled as a [counter]({{<baseurl>}}riak/kv/3.2.5/developing/data-types/#counters), [set]({{<baseurl>}}riak/kv/3.2.5/developing/data-types/#sets), or [map]({{<baseurl>}}riak/kv/3.2.5/developing/data-types/#maps), then you should seriously
...
resolution that we implemented above, see our [tutorial on Riak sets]({{<baseurl>}}riak/kv/3.2.5/developing/data-types/#sets).
