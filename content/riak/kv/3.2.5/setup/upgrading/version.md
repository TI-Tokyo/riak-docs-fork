---
title: "Upgrading to Riak KV 3.2.6"
description: ""
project: "riak_kv"
...
menu:
  riak_kv-3.2.6:
    name: "Upgrading to 3.2.6"
    identifier: "upgrading_version"
    weight: 101
    parent: "upgrading"
toc: true
aliases:
  - /riak/3.2.6/upgrade-v20/
  - /riak/kv/3.2.6/ops/upgrading/rolling-upgrades/
  - /riak/kv/3.2.6/ops/upgrading/rolling-upgrades/
  - /riak/kv/3.2.6/setup/upgrading/cluster/

---

[production checklist]: {{<baseurl>}}riak/kv/3.2.6/setup/upgrading/checklist
...
[release notes]: {{<baseurl>}}riak/kv/3.2.6/release-notes
...
[jmx monitor]: {{<baseurl>}}riak/kv/3.2.6/using/reference/jmx
[snmp]: {{<baseurl>}}riak/kv/3.2.6/using/reference/snmp
[Release Notes]: {{<baseurl>}}riak/kv/3.2.6/release-notes

## Overview

You can upgrade one node or your whole cluster to Riak KV 3.2.6 by following the instructions below.
