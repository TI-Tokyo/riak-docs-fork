...
toc: true
aliases:
  - /riak/3.2.6/ops/advanced/backends/leveled/
  - /riak/kv/3.2.6/ops/advanced/backends/leveled/
---
...
[config reference#aae]: {{<baseurl>}}riak/kv/3.2.6/configuring/reference/#active-anti-entropy
...
Leveled is included with Riak KV 3.2.6 and beyond, so there is no need to install anything further.
