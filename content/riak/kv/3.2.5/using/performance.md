...
toc: true
aliases:
  - /riak/kv/3.2.6/ops/tuning/linux/
  - /riak/3.2.6/ops/tuning/linux/
---
...
clusters on the Amazon Web Services EC2 environment, see [AWS Performance Tuning]({{<baseurl>}}riak/kv/3.2.6/using/performance/amazon-web-services).
...
open files limit is necessary. See [Open Files Limit]({{<baseurl>}}riak/kv/3.2.6/using/performance/open-files-limit/) for more
details.

## Other Tuning Docs

* [AWS Performance Tuning]({{<baseurl>}}riak/kv/3.2.6/using/performance/amazon-web-services)
* [Erlang VM Tuning]({{<baseurl>}}riak/kv/3.2.6/using/performance/erlang)
* [Latency Reduction]({{<baseurl>}}riak/kv/3.2.6/using/performance/latency-reduction)
* [Open Files Limit]({{<baseurl>}}riak/kv/3.2.6/using/performance/open-files-limit/)
