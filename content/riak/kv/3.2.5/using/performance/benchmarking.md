...
toc: true
aliases:
  - /riak/3.2.6/ops/building/benchmarking
  - /riak/kv/3.2.6/ops/building/benchmarking
---
...
* Erlang must be installed. See [Installing Erlang]({{<baseurl>}}riak/kv/3.2.6/setup/installing/source/erlang) for instructions
