...
[pre/post-commit hooks]({{<baseurl>}}riak/kv/3.2.5/developing/usage/commit-hooks), and MapReduce operations. This
doc contains installation steps with simple examples for each use case.

Your developers can compile [custom erlang code]({{<baseurl>}}riak/kv/3.2.5/developing/usage/commit-hooks), which
...
in the [Commands documentation]({{<baseurl>}}riak/kv/3.2.5/using/admin/riak-admin/#wait-for-service).
