...
[`riak admin`]({{<baseurl>}}riak/kv/3.2.6/using/admin/riak-admin/) interface enables you to
...
Note: In KV 3.2.6 + this command has been deprecated and no longer functions.
...
This command displays the values for handoff-specific [configurable parameters]({{<baseurl>}}riak/kv/3.2.6/configuring/reference/#intra-cluster-handoff) on each node in
