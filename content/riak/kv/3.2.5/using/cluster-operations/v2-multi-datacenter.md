...
v2 Multi-Datacenter Replication is deprecated and will be removed in a future version. Please use [v3]({{<baseurl>}}riak/kv/3.2.5/using/cluster-operations/v3-multi-datacenter/) instead.
{{% /note %}}
...
Field | Description
:-----|:-----------
`client_stats` | See <a href="{{< baseurl >}}riak/kv/3.2.5/using/reference/multi-datacenter/statistics/#client-statistics">Client Statistics</a>
...
`server_stats` | See <a href="{{< baseurl >}}riak/kv/3.2.5/using/reference/multi-datacenter/statistics/#server-statistics">Server Statistics</a>
...
participate in realtime replication. Please see the [Riak MDC Replication Configuration]({{<baseurl>}}riak/kv/3.2.5/configuring/v2-multi-datacenter/) guide for more information.
...
`fullsync_worker` | The Erlang process ID of the fullsync worker
`bounded_queue` | See the <a href="{{< baseurl >}}riak/kv/3.2.5/using/cluster-operations/v2-multi-datacenter/#bounded-queue">Bounded Queue</a> section above
