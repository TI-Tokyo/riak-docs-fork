...
toc: true
aliases:
  - /riak/3.2.6/ops/running/nodes/adding-removing
  - /riak/kv/3.2.6/ops/running/nodes/adding-removing
---
...
simply the script [`riak`]({{<baseurl>}}riak/kv/3.2.6/using/admin/riak-cli/):
