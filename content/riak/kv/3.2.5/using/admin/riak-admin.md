...
toc: true
aliases:
  - /riak/3.2.6/ops/running/tools/riak-admin
  - /riak/kv/3.2.6/ops/running/tools/riak-admin
---
...
[use admin commands#join]: {{<baseurl>}}riak/kv/3.2.6/using/admin/commands/#join
[use admin commands#leave]: {{<baseurl>}}riak/kv/3.2.6/using/admin/commands/#leave
[cluster ops backup]: {{<baseurl>}}riak/kv/3.2.6/using/cluster-operations/backing-up
[config reference#node-metadata]: {{<baseurl>}}riak/kv/3.2.6/configuring/reference/#node-metadata
...
[config reference#ring]: {{<baseurl>}}riak/kv/3.2.6/configuring/reference/#ring
...
[downgrade]: {{<baseurl>}}riak/kv/3.2.6/setup/downgrade
...
[use admin riak admin#stats]: {{<baseurl>}}riak/kv/3.2.6/using/admin/riak-admin/#stats
...
**Note**: This command has been deprecated in KV 3.2.6 onwards and will no longer function.
