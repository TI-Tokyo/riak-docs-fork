...
aliases:
  ...
  - /riak/kv/3.2.3/ops/running/cluster-admin
---

[use admin riak admin#cluster]: {{<baseurl>}}riak/kv/3.2.3/using/admin/riak-admin/#cluster
...
[use admin riak admin#cluster-plan]: {{<baseurl>}}riak/kv/3.2.3/using/admin/riak-admin/#cluster-plan
[use admin riak admin#cluster-commit]: {{<baseurl>}}riak/kv/3.2.3/using/admin/riak-admin/#cluster-commit
