...
aliases:
  ...
  - /riak/kv/3.2.3/ops/running/tools/riak
---

[configuration file]: {{<baseurl>}}riak/kv/3.2.3/configuring/reference/
[escript]: http://www.erlang.org/doc/man/escript.html
[`riak admin`]: {{<baseurl>}}riak/kv/3.2.3/using/admin/riak-admin/#top
[configuration]: {{<baseurl>}}riak/kv/3.2.3/configuring/reference/
