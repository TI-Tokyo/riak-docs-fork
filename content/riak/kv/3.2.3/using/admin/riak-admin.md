...
aliases:
  ...
  - /riak/kv/3.2.3/ops/running/tools/riak-admin
---
...
[use admin commands#join]: {{<baseurl>}}riak/kv/3.2.3/using/admin/commands/#join
[use admin commands#leave]: {{<baseurl>}}riak/kv/3.2.3/using/admin/commands/#leave
[cluster ops backup]: {{<baseurl>}}riak/kv/3.2.3/using/cluster-operations/backing-up
[config reference#node-metadata]: {{<baseurl>}}riak/kv/3.2.3/configuring/reference/#node-metadata
...
[config reference#ring]: {{<baseurl>}}riak/kv/3.2.3/configuring/reference/#ring
...
[downgrade]: {{<baseurl>}}riak/kv/3.2.3/setup/downgrade
...
[use admin riak admin#stats]: {{<baseurl>}}riak/kv/3.2.3/using/admin/riak-admin/#stats
