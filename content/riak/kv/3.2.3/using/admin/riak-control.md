...
aliases:
  ...
  - /riak/kv/3.2.3/ops/advanced/riak-control
---
...
enabled on each Riak node. For more information, see our [security documentation]({{<baseurl>}}riak/kv/3.2.3/using/security/basics#enabling-ssl). Once SSL is enabled, you can proceed to setting up [authentication](#authentication) for Riak Control.
...
see the health of each [vnode]({{<baseurl>}}riak/kv/3.2.3/learn/glossary/#vnode).
