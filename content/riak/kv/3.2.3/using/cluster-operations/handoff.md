...
[`riak admin`]({{<baseurl>}}riak/kv/3.2.3/using/admin/riak-admin/) interface enables you to
...
This command displays the values for handoff-specific [configurable parameters]({{<baseurl>}}riak/kv/3.2.3/configuring/reference/#intra-cluster-handoff) on each node in
