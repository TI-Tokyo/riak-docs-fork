...
by accessing the Erlang console directly using the [`riak attach`]({{<baseurl>}}riak/kv/3.2.3/using/admin/riak-cli/#attach) command. Once you run this command and drop into the console, enter the following:
