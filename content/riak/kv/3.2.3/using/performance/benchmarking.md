...
aliases:
  ...
  - /riak/kv/3.2.3/ops/building/benchmarking
---
...
* Erlang must be installed. See [Installing Erlang]({{<baseurl>}}riak/kv/3.2.3/setup/installing/source/erlang) for instructions
