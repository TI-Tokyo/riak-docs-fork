...
aliases:
  ...
  - /riak/kv/3.2.3/ops/running/stats-and-monitoring
---
...
are made available through the HTTP API via the [`/stats`]({{<baseurl>}}riak/kv/3.2.3/developing/api/http/status) endpoint, or through the [`riak admin`]({{<baseurl>}}riak/kv/3.2.3/using/admin/riak-admin/) interface, in particular the `stat` and `status` commands.
...
Riak statistics provided in the [Inspecting a Node]({{<baseurl>}}riak/kv/3.2.3/using/cluster-operations/inspecting-node) and [HTTP Status]({{<baseurl>}}riak/kv/3.2.3/developing/api/http/status) documentation.
...
documentation on [system tuning]({{<baseurl>}}riak/kv/3.2.3/using/performance/#storage-and-file-system-tuning).
...
If graphing all of the [available Riak metrics]({{<baseurl>}}riak/kv/3.2.3/using/cluster-operations/inspecting-node) is
...
The [`riak admin`]({{<baseurl>}}riak/kv/3.2.3/using/admin/riak-admin/) tool provides two
...
[Inspecting a Node]({{<baseurl>}}riak/kv/3.2.3/using/cluster-operations/inspecting-node/#riak admin-status) document.
...
in the [Inspecting a Node]({{<baseurl>}}riak/kv/3.2.3/using/admin/riak-admin/#stat) document.
...
[Riak Control]({{<baseurl>}}riak/kv/3.2.3/using/admin/riak-control/) is Basho's REST-driven user-interface for managing Riak
...
the Riak HTTP [`/stats`]({{<baseurl>}}riak/kv/3.2.3/developing/api/http/status) endpoint is also available.
...
A [Riak New Relic Agent][riak_new_relic] for collecting statistics from the Riak HTTP [`/stats`]({{<baseurl>}}riak/kv/3.2.3/developing/api/http/status) endpoint is also available.
...
[`/stats`]({{<baseurl>}}riak/kv/3.2.3/developing/api/http/status) endpoint.
...
* [Inspecting a Node]({{<baseurl>}}riak/kv/3.2.3/using/cluster-operations/inspecting-node)
* [Riaknostic](http://riaknostic.basho.com)
* [Riak Control]({{<baseurl>}}riak/kv/3.2.3/using/admin/riak-control/)
