...
aliases:
  ...
  - /riak/kv/3.2.3/ops/mdc/v3/cascading-writes
---
...
`riak repl` command. Please see the [Version 3 Operations guide]({{<baseurl>}}riak/kv/3.2.3/using/cluster-operations/v3-multi-datacenter) for more information.
