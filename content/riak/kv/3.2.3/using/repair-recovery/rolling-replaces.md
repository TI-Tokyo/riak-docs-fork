...
[upgrade]: {{<baseurl>}}riak/kv/3.2.3/setup/upgrading/cluster/
[rolling restarts]: {{<baseurl>}}riak/kv/3.2.3/using/repair-recovery/rolling-restart/
[add node]: {{<baseurl>}}riak/kv/3.2.3/using/cluster-operations/adding-removing-nodes
