...
aliases:
  ...
  - /riak/kv/3.2.3/theory/concepts/Replication
  - /riak/3.2.3/theory/concepts/replication
  - /riak/kv/3.2.3/theory/concepts/replication
keywords: "nval n_val"
---
...
[concept causal context vc]: {{<baseurl>}}riak/kv/3.2.3/learn/concepts/causal-context/#vector-clocks
[concept clusters]: {{<baseurl>}}riak/kv/3.2.3/learn/concepts/clusters
[concept vnodes]: {{<baseurl>}}riak/kv/3.2.3/learn/concepts/vnodes
[glossary node]: {{<baseurl>}}riak/kv/3.2.3/learn/glossary/#node
[glossary ring]: {{<baseurl>}}riak/kv/3.2.3/learn/glossary/#ring
[usage replication]: {{<baseurl>}}riak/kv/3.2.3/developing/usage/replication
...
bucket's [bucket type]({{<baseurl>}}riak/kv/3.2.3/developing/usage/bucket-types).
...
[Multi-Datacenter Replications]({{<baseurl>}}riak/kv/3.2.3/configuring/planning/v3-multi-datacenter) capabilities.
...
type]({{<baseurl>}}riak/kv/3.2.3/developing/usage/bucket-types) with `n_val` set to your desired value and
...
queries, e.g. [secondary index]({{<baseurl>}}riak/kv/3.2.3/developing/usage/secondary-indexes/) and
[MapReduce]({{<baseurl>}}riak/kv/3.2.3/developing/usage/mapreduce/) queries. Lowering an object or bucket's
