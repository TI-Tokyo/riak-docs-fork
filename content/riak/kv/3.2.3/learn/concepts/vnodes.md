...
aliases:
  ...
  - /riak/kv/3.2.3/theory/concepts/vnodes
---

[concept causal context]: {{<baseurl>}}riak/kv/3.2.3/learn/concepts/causal-context
[concept clusters ring]: {{<baseurl>}}riak/kv/3.2.3/learn/concepts/clusters/#the-ring
...
subdirectories. If you're using, say, [Bitcask]({{<baseurl>}}riak/kv/3.2.3/setup/planning/backend/bitcask) as a backend, navigate
