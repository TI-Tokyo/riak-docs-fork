...
aliases:
  ...
  - /riak/kv/3.2.3/theory/concepts/crdts
---

[crdts pdf]: http://hal.upmc.fr/docs/00/55/55/88/PDF/techreport.pdf
[data types converg]: {{<baseurl>}}riak/kv/3.2.3/learn/concepts/crdts/#convergence
[crdts reading list]: http://christophermeiklejohn.com/crdt/2014/07/22/readings-in-crdts.html
[data types impl]: {{<baseurl>}}riak/kv/3.2.3/learn/concepts/crdts/#implementation
[concept causal context dvv]: {{<baseurl>}}riak/kv/3.2.3/learn/concepts/causal-context/#dotted-version-vectors
[concept causal context sib]: {{<baseurl>}}riak/kv/3.2.3/learn/concepts/causal-context/#siblings
...
[dev data types context]: {{<baseurl>}}riak/kv/3.2.3/developing/data-types/#data-types-and-context
