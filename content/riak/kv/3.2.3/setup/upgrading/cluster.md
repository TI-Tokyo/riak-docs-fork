...
aliases:
  ...
  - /riak/kv/3.2.3/ops/upgrading/rolling-upgrades/
---

[production checklist]: {{<baseurl>}}riak/kv/3.2.3/setup/upgrading/checklist
...
[jmx monitor]: {{<baseurl>}}riak/kv/3.2.3/using/reference/jmx
[snmp]: {{<baseurl>}}riak/kv/3.2.3/using/reference/snmp
...
If you run [Riak Control]({{<baseurl>}}riak/kv/3.2.3/using/admin/riak-control), you should disable it during the rolling upgrade process.
{{% /note %}}
