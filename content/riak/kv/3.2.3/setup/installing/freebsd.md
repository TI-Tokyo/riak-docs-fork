...
```bash
sudo pkg_add -r https://files.tiot.jp/riak/kv/3.0/3.2.3/freebsd/11.1/riak-3.2.3.txz
```

### For FreeBSD 10.x

```bash
sudo pkg_add -r https://files.tiot.jp/riak/kv/3.0/3.2.3/freebsd/10.4/riak-3.2.3.txz
```
