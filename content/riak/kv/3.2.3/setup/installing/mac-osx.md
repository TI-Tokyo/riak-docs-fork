...
aliases:
  ...
  - /riak/kv/3.2.3/ops/building/installing/Installing-on-Mac-OS-X
  - /riak/3.2.3/installing/mac-osx/
  - /riak/kv/3.2.3/installing/mac-osx/
---
...
```bash
curl -O https://files.tiot.jp/riak/kv/3.0/3.2.3/osx/10.11/riak-3.2.3-OSX-x86_64.tar.gz
...
```bash
curl -O https://files.tiot.jp/riak/kv/3.0/3.2.3/riak-3.2.3.tar.gz
