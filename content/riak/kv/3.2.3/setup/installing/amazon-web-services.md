...
aliases:
  ...
  - /riak/kv/3.2.3/ops/building/installing/Installing-on-AWS-Marketplace
  - /riak/3.2.3/installing/amazon-web-services/
  - /riak/kv/3.2.3/installing/amazon-web-services/
---
...
We also recommend that you read more about Riak's [Security and Firewalls]({{<baseurl>}}riak/kv/3.2.3/using/security/).
...
```bash
wget https://files.tiot.jp/riak/kv/3.0/3.2.3/amazon/2/riak-3.2.3-1.amzn2x86_64.rpm
...
```bash
wget https://files.tiot.jp/riak/kv/3.0/3.2.3/amazon/2016.09/riak-3.2.3-1.amzn1x86_64.rpm
