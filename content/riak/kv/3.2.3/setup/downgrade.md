...
aliases:
  ...
  - /riak/kv/3.2.3/ops/upgrading/rolling-downgrades/
---

[rolling upgrade]: {{<baseurl>}}riak/kv/3.2.3/setup/upgrading/cluster
...
[aae status]: {{<baseurl>}}riak/kv/3.2.3/using/admin/riak-admin/#aae-status
