...
aliases:
  ...
  - /riak/kv/3.2.3/dev/references/protocol-buffers/get-client-id
---
...
connected and can be changed using [Set Client ID]({{<baseurl>}}riak/kv/3.2.3/developing/api/protocol-buffers/set-client-id).
