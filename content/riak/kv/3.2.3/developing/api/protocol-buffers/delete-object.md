...
aliases:
  ...
  - /riak/kv/3.2.3/dev/references/protocol-buffers/delete-object
---

Delete an object in the specified [bucket type]({{<baseurl>}}riak/kv/3.2.3/using/cluster-operations/bucket-types)/bucket/key location.
