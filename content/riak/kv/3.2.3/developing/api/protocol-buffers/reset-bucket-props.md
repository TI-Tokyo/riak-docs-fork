...
aliases:
  ...
  - /riak/kv/3.2.3/dev/references/protocol-buffers/reset-bucket-props
---
...
[bucket type]({{<baseurl>}}riak/kv/3.2.3/developing/usage/bucket-types) using the `type` value. If you do not
