...
aliases:
  ...
  - /riak/kv/3.2.3/dev/references/protocol-buffers/mapreduce
---
...
The JSON encoding is the same as [REST API]({{<baseurl>}}riak/kv/3.2.3/developing/usage/mapreduce/#rest) and
the external term format is the same as the [local Erlang API]({{<baseurl>}}riak/kv/3.2.3/developing/app-guide/advanced-mapreduce/#erlang)
