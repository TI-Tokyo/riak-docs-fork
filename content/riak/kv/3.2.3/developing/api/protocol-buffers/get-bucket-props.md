...
aliases:
  ...
  - /riak/kv/3.2.3/dev/references/protocol-buffers/get-bucket-props
---
...
The bucket's name (`bucket`) must be specified. The [bucket type]({{<baseurl>}}riak/kv/3.2.3/using/cluster-operations/bucket-types) parameter (`type`) is optional. If it is not specified,
...
[configuration file]({{<baseurl>}}riak/kv/3.2.3/configuring/reference/#default-bucket-properties) documentation.
