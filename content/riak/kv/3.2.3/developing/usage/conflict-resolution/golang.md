...
aliases:
  ...
  - /riak/kv/3.2.3/dev/using/conflict-resolution/golang
---

For reasons explained in the [Introduction to conflict resolution]({{<baseurl>}}riak/kv/3.2.3/developing/usage/conflict-resolution), we strongly recommend adopting a conflict resolution strategy that
