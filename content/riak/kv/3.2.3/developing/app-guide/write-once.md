...
aliases:
  ...
  - /riak/kv/3.2.3/dev/advanced/write-once
---

[glossary vnode]: {{<baseurl>}}riak/kv/3.2.3/learn/glossary/#vnode
[bucket type]: {{<baseurl>}}riak/kv/3.2.3/developing/usage/bucket-types
[Riak data types]: {{<baseurl>}}riak/kv/3.2.3/developing/data-types
[strong consistency]: {{<baseurl>}}riak/kv/3.2.3/developing/app-guide/strong-consistency
...
The [Multi]({{<baseurl>}}riak/kv/3.2.3/setup/planning/backend/multi) backend does not
