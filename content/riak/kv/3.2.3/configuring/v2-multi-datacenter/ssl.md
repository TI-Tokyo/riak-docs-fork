...
aliases:
  ...
  - /riak/kv/3.2.3/ops/mdc/v2/ssl
---

{{% note title="Deprecation Warning" %}}
v2 Multi-Datacenter Replication is deprecated and will be removed in a future version. Please use [v3]({{<baseurl>}}riak/kv/3.2.3/configuring/v3-multi-datacenter/ssl/) instead.
{{% /note %}}
