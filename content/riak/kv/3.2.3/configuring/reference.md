...
aliases:
  ...
  - /riak/kv/3.2.3/ops/advanced/configs/configuration-files/
search_boost: 10
---
...
<td>
he directory in which the <a href="../../using/admin/riak admin"><code>riak admin</code></a>,
...
as <a href="{{<baseurl>}}riak/kv/3.2.3/learn/glossary/#active-anti-entropy-aae">active anti-entropy</a> data, and cluster metadata
</td>
...
associated <a href="{{<baseurl>}}riak/kv/3.2.3/learn/glossary/#vnode">vnode</a> before assuming that the vnode
...
href="{{<baseurl>}}riak/kv/3.2.3/learn/glossary/#vnode">vnodes</a> attempt to trigger <a
href="{{<baseurl>}}riak/kv/3.2.3/learn/glossary/#hinted-handoff">handoff</a> between
...
%% to release 3.2.3 it was set to a default of 10.</td>
<td><code>5</code></td><td>
</tr>
