...
aliases:
  ...
  - /riak/kv/3.2.3/ops/mdc/v2/configuration
---

[config v2 ssl]: {{<baseurl>}}riak/kv/3.2.3/configuring/v2-multi-datacenter/ssl

{{% note title="Deprecation Warning" %}}
v2 Multi-Datacenter Replication is deprecated and will be removed in a future version. Please use [v3]({{<baseurl>}}riak/kv/3.2.3/configuring/v3-multi-datacenter/) instead.
{{% /note %}}
