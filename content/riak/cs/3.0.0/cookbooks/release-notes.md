...
This is a backwards-compatible* release that updates node_package to address a recent [Product Advisory]({{<baseurl>}}/iak/community/product-advisories/codeinjectioninitfiles/), as well as fixes several bugs.
