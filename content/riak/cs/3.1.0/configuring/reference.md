...
recommend consulting the [configuring Riak CS]({{<baseurl>}}riak/cs/3.1.0/configuring/riak-cs) tutorial.
...
corresponding settings in the <a href="{{< baseurl >}}riak/cs/3.1.0/learning/stanchion">Stanchion</a> node's <code>stanchion.conf</code>.
</td>
<td><code>admin-key</code></td>
</tr>
<tr>
...
corresponding settings in the <a href="{{< baseurl >}}riak/cs/3.1.0/learning/stanchion">Stanchion</a> node's
...
Settings related to Riak CS's [garbage collection]({{<baseurl>}}riak/cs/3.1.0/learning/garbage-collection) /(GC) process.
...
features for the current version to better support <a href="{{< baseurl >}}riak/cs/3.1.0/setup/upgrading">rolling upgrades</a>. New
...
enable new features for the current version to better support <a href="{{< baseurl >}}riak/cs/3.1.0/setup/upgrading">rolling upgrades</a>. New installs shouldn't need to modify this. If you're performing a rolling upgrade, keep the original value (if not defined, Riak CS uses <code>0</code>) of the old <code>app.config</code> until all nodes have been upgraded. At that point, set to the new value.</td>
<td><code></code></td>
</tr>
<tr>
