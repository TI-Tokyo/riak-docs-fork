...
menu:
  riak_cs-3.1.0:
    ...
    identifier: "config_mdc"
    weight: 150
    parent: "config"
project: "riak_cs"
project_version: "3.1.0"
aliases:
  - /riak/cs/3.1.0/cookbooks/configuration/multi-datacenter/
  - /riakcs/3.1.0/cookbooks/configuration/multi-datacenter/
...
Though there is no specific configuration for [Stanchion]({{<baseurl>}}riak/cs/3.1.0/learning/stanchion), note that
...
updates to [globally unique entities]({{<baseurl>}}riak/cs/3.1.0/learning/stanchion/#globally-unique-entities) like users and buckets.
