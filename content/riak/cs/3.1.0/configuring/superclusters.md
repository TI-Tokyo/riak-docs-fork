...
more heavily than another you can increase the weight of that member using the interface described in [Riak CS Command-line Tools]({{<baseurl>}}riak/cs/3.1.0/using/command-line-tools).
...
3. Set your desired Stanchion [configuration]({{<baseurl>}}riak/cs/3.1.0/configuring/stanchion).
...
When a new supercluster member is added, you must first set the weight of that member to zero using the [`riak-cs-supercluster`]({{<baseurl>}}riak/cs/3.1.0/using/command-line-tools) command-line interface.
...
in our documentation on [Riak CS Command Line Tools]({{<baseurl>}}riak/cs/3.1.0/using/command-line-tools/#riak-cs-supercluster).
