---
title: "The Quick Guide to Riak CS"
description: ""
menu:
  riak_cs-3.1.0:
    name: "Quick Guide"
    identifier: "quick_guide"
    pre: time
    weight: 200
project: "riak_cs"
project_version: "3.1.0"
aliases:
  - /riak/cs/3.1.0/tutorials/fast-track/
  - /riakcs/3.1.0/tutorials/fast-track/
  - /riak/cs/3.1.0/cookbooks/tutorials/fast-track/
  - /riakcs/3.1.0/cookbooks/tutorials/fast-track/
---
...
## What is The Quick Guide to Riak CS?

The Quick Guide to Riak CS aims to get you up and running with Riak as
...
The Quick Guide is designed for people with little or no experience with
Riak CS, but can still be useful for more experienced users as well.

## What does the Quick Guide cover?

The Quick Guide takes you through the following sections:
