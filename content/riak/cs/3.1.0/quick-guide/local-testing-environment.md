...
menu:
  riak_cs-3.1.0:
    ...
    identifier: "quick_guide_local_test"
    weight: 101
    parent: "quick_guide"
project: "riak_cs"
project_version: "3.1.0"
aliases:
  - /riakcs/3.1.0/tutorials/fast-track/local-testing-environment/
  - /riak/cs/3.1.0/tutorials/fast-track/local-testing-environment/
  - /riakcs/3.1.0/cookbooks/tutorials/fast-track/Building-a-Local-Test-Environment/
  - /riak/cs/3.1.0/cookbooks/tutorials/fast-track/Building-a-Local-Test-Environment/
---
...
configuration, there is an option for [Building a Virtual Testing Environment]({{<baseurl>}}riak/cs/3.1.0/quick-guide/virtual-test-environment).
...
For Mac OS X, consult the [open files limit]({{<baseurl>}}riak/kv/latest/using/performance/open-files-limit/) documentation for Mac OS X specific details.
...
[Download Riak]({{<baseurl>}}riak/kv/latest/downloads/) and [Download Riak CS]({{<baseurl>}}riak/cs/3.1.0/downloads).
...
Once you have completed this step, You can progress to [testing the Riak CS installation]({{<baseurl>}}riak/cs/3.1.0/quick-guide/test-installation) using s3cmd.
