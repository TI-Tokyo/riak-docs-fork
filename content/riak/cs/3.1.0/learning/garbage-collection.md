...
menu:
  riak_cs-3.1.0:
    ...
    identifier: "learning_garbage_collection"
    weight: 120
    parent: "learning"
project: "riak_cs"
project_version: "3.1.0"
aliases:
  - /riakcs/3.1.0/cookbooks/garbage-collection/
  - /riak/cs/3.1.0/cookbooks/garbage-collection/
---
...
system, please see our documentation on [configuring Riak CS]({{<baseurl>}}riak/cs/3.1.0/configuring/riak-cs).
...
[CS configuration doc]({{<baseurl>}}riak/cs/3.1.0/cookbooks/configuring/riak-cs/#garbage-collection-settings).
...
For more information, see our documentation on [Riak CS command-line tools]({{<baseurl>}}riak/cs/3.1.0/using/command-line-tools).
...
can be found in our documentation on [configuring Riak CS]({{<baseurl>}}riak/cs/3.1.0/configuring/riak-cs/#garbage-collection-settings).
