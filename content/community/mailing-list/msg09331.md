...
description: ""
project: community
lastmod: 2012-11-14T18:00:21-08:00
sitemap:
  priority: 0.2
layout: mailinglistitem
mailinglist_id: "msg09331"
mailinglist_parent_id: "msg09327"
author_name: "David Lowell"
project_section: "mailinglistitem"
sent_date: 2012-11-14T18:00:21-08:00
---
...
if I run 'kv.bucket("ctv\\_tvdata").get\\_keys()' on this host, Riak logs hundreds 
...
&gt; And I've seen three periods whereby we get hundreds of "riak\\_kv\\_vnode worker 
...
&gt; &gt;&gt;&gt; import riak
&gt; &gt;&gt;&gt; kv = riak.RiakClient()
&gt; &gt;&gt;&gt; kv.bucket("ctv\\_tvdata").get\\_keys()
&gt; 
&gt; This call never returns, and within a few seconds of running it, the 
&gt; console.log fills with "riak\\_kv\\_vnode worker pool crashed" and "CRASH REPORT" 
&gt; log messages.
&gt; 
...
&gt;&gt;&gt;&gt;&gt; logs like "riak\\_kv\\_vnode worker pool crashed", but we started seeing 
&gt;&gt;&gt;&gt;&gt; lots of new error records in the logs about "Unrecognized message" as 
&gt;&gt;&gt;&gt;&gt; well. In both cases, we see tons of these "long\\_gc" monitoring messages 
&gt;&gt;&gt;&gt;&gt; and several "system\\_memory\\_high\\_watermark" alarms during these periods. 
...
&gt;&gt;&gt;&gt;&gt;&gt; in 1.3).
&gt;&gt;&gt;&gt;&gt;&gt; 
&gt;&gt;&gt;&gt;&gt;&gt; I will assume your leveldb "data\\_root" is "/var/db/riak/leveldb" for 
...
&gt;&gt;&gt;&gt;&gt;&gt;&gt; 2012-11-07 01:56:22.382 [error] &lt;0.10002.0&gt; gen\\_fsm &lt;0.10002.0&gt; in 
...
&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Sunday evening. Facilitating this sort of recovery does seem to 
&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; require shutting down all application KV requests for a while.
&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
