...
description: ""
project: community
lastmod: 2015-12-08T07:17:31-08:00
sitemap:
  priority: 0.2
layout: mailinglistitem
mailinglist_id: "msg16853"
mailinglist_parent_id: "msg16850"
author_name: "Joe Olson"
project_section: "mailinglistitem"
sent_date: 2015-12-08T07:17:31-08:00
---
...
http://basho.github.io/riak-python-client/bucket.html#bucket-objects . I looked 
...
metadata and data, if possible. If your key is "my\_stuff", then have your data 
stored in the bucket "data" and the metadata stored in the bucket "metadata". 
So that you'd fetch "metadata/my\_stuff", then fetch "data/my\_stuff". This 
...
- when writing your data, start by writing "data/my\_stuff" with conservative 
...
the metadata, if you're using the PB API, you can pass "n\_val" as parameter of 
your request. If you pass n\_val=1, then Riak will not query the 3 replicas to 
...
the replica is) for a given key. Coupled with passing n\_val=1, Riak will not 
