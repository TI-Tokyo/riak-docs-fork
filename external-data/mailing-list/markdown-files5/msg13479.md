...
description: ""
project: community
lastmod: 2014-01-24T10:53:54-08:00
sitemap:
  priority: 0.2
layout: mailinglistitem
mailinglist_id: "msg13479"
mailinglist_parent_id: "msg13475"
author_name: "Bryce Verdier"
project_section: "mailinglistitem"
sent_date: 2014-01-24T10:53:54-08:00
---
...
the python 2.0.2 client, so I assume its riak\\_dt\\_pncounter)
...
That binary (&lt;&lt;69,1,71…&gt;&gt;) says CRDT(69), Version 1(1), riak\\_kv\\_pncounter (71). The error 
says that erlang is trying to apply the Module, Function, Arguments of 
&lt;&lt;“riak\\_kv\\_pncounter”&gt;&gt;, new, []. But modules need to be atoms.
...
probably only want the Value bit. So:
 ...
 {{\\_Ctx, Count}, \\_Stats} = riak\\_kv\\_crdt:value(RiakObject, 
riak\\_kv\\_pncounter),
...
In 1.4 there was just the simple function riak\\_kv\\_counters:value. In 2.0 I found the 
riak\\_kv\\_crdt module, which has a value function in it. But I'm not sure what 
