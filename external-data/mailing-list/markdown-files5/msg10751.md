...
description: ""
project: community
lastmod: 2013-04-08T07:19:28-07:00
sitemap:
  priority: 0.2
layout: mailinglistitem
mailinglist_id: "msg10751"
author_name: "Ingo Rockel"
project_section: "mailinglistitem"
sent_date: 2013-04-08T07:19:28-07:00
---


I already tried the HEAD-Request, which resulted in the same 503 after 
...
irockel@bighead:~$ curl -v -X DELETE "http://172.22.3.22:8091/riak/m/Oa|1"
...
you
could
track the object\\_size stats on the cluster, I think that we
might
see
...
sys\\_process\\_count is somewhere between 5k and 11k on the
nodes
right
now.
...
helped
reducing
the busy\\_dist\\_port and Monitor got {suppressed,...
Messages
a
lot.
But
...
The eleveldb section:
 ...
 {data\\_root, "/var/lib/riak/leveldb"},
 {cache\\_size, 33554432},
 {write\\_buffer\\_size\\_min, 67108864}, %%
64
MB
in bytes
...
ERL\\_MAX\\_PORTS,
and ERL\\_MAX\\_ETS\\_TABLES. Are any of these set? If so,
to
what?
